...
// effectively a column major 3x2 matrix
#[derive(Debug, Clone)]
...
impl GlobalTransform2D {
    ...
    pub const IDENTITY: GlobalTransform2D = GlobalTransform2D::new(Vec2::ZERO, Vec2::RIGHT, Vec2::UP);
...
impl GlobalTransform3D {
    pub const IDENTITY: GlobalTransform3D =
        GlobalTransform3D::new(Vec3::ZERO, Vec3::RIGHT, Vec3::UP, Vec3::FORWARD);
...
mod tests {
    ...
    use super::GlobalTransform2D;

    #[test]
    fn scale_2d() {
        let mut t = GlobalTransform2D::new(Vec2::ZERO, Vec2::RIGHT, Vec2::UP);
